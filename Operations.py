class opeartion:
    ...
    # Thisfrom Operations  import opeartion as oper
...
if choice == ('1'):
    ...
    def sinn(x):
        return math.sin(x)
    # This function tan the number
    def tann(x):
        return math.tan(x)
    # This function squared the number
    def squared1(x):
        return x ** 2

    # This function power the number
    def power1(x, y):
        return x ** y
    # This function percentage the number
    def percentage1(x, y):
        return x % y
    # This function sqrt the number
    def root1(x):
        return math.sqrt(x)
